                  ...
                  children: [
                    ...
                    Consumer<MediaProvider>(
                      builder: (context, provider, _) {
                        bool isActive = provider.processingStatus.values.any((s) => s != 'Done' && s != 'Error');
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                Expanded(child: Divider(color: Colors.white.withValues(alpha: 0.05), height: 1)),
              ],
            ),
          ),
          _NavItem(
        ...
        child: InkWell(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(12),
              border: isSelected 
                ? Border.all(color: const Color(0xFFE9B3FF).withValues(alpha: 0.2), width: 0.5)
                : null,
            ),
            child: Row(
              children: [
